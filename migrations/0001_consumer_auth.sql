...
-- cts-ui. Applied by scripts/provision-auth-db.mjs, which also creates the
-- dedicated `cts_ui_app` role this app connects as (least privilege: this
-- schema only, plus SELECT on parcels.* like consumer_reader already has).
